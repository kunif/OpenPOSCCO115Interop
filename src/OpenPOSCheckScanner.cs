...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.CheckScanner, "OpenPOS 1.15 CheckScanner", "OPOS CheckScanner CCO Interop", 1, 15)]
    public class OpenPOSCheckScanner : CheckScanner, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSCheckScanner _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSCheckScanner();
        ...
        #endregion OPOSCheckScanner  Specific Properties
        ...
        #endregion OPOSCheckScanner  Specific Methodss
    }
}