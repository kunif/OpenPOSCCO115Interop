...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.ElectronicJournal, "OpenPOS 1.15 ElectronicJournal", "OPOS ElectronicJournal CCO Interop", 1, 15)]
    public class OpenPOSElectronicJournal : ElectronicJournal, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSElectronicJournal _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSElectronicJournal();
        ...
        #endregion OPOSElectronicJournal  Specific Properties
        ...
        #endregion OPOSElectronicJournal  Specific Methodss
    }
}