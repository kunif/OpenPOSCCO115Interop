...
namespace OpenPOS.CCO115Interop
{
    ...
    {
        private OpenPOS.Devices.OPOSElectronicValueRW _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSElectronicValueRW();
        ...
        #endregion ElectronicValueRW Specific Properties

        #region ElectronicValueRW 1.15 Specific Properties

        public bool CapAdditionalSecurityInformation
        {
            get { return _cco.CapAdditionalSecurityInformation; }
        }

        public bool CapAuthorizeCompletion
        {
            get { return _cco.CapAuthorizeCompletion; }
        }

        public bool CapAuthorizePreSales
        {
            get { return _cco.CapAuthorizePreSales; }
        }

        public bool CapAuthorizeRefund
        {
            get { return _cco.CapAuthorizeRefund; }
        }

        public bool CapAuthorizeVoid
        {
            get { return _cco.CapAuthorizeVoid; }
        }

        public bool CapAuthorizeVoidPreSales
        {
            get { return _cco.CapAuthorizeVoidPreSales; }
        }

        public bool CapCashDeposit
        {
            get { return _cco.CapCashDeposit; }
        }

        public bool CapCenterResultCode
        {
            get { return _cco.CapCenterResultCode; }
        }

        public bool CapCheckCard
        {
            get { return _cco.CapCheckCard; }
        }

        public CatLogs CapDailyLog
        {
            get { return (CatLogs)InteropEnum<CatLogs>.ToEnumFromInteger(_cco.CapDailyLog); }
        }

        public bool CapInstallments
        {
            get { return _cco.CapInstallments; }
        }

        public bool CapPaymentDetail
        {
            get { return _cco.CapPaymentDetail; }
        }

        public bool CapTaxOthers
        {
            get { return _cco.CapTaxOthers; }
        }

        public bool CapTransactionNumber
        {
        ...
        public PaymentMedia PaymentMedia
        {
            get
            {
        ...
        public ServiceType115 ServiceType115
        {
            get { return (ServiceType115)InteropEnum<ServiceType115>.ToEnumFromInteger(_cco.ServiceType); }
        }
        ...
        #endregion ElectronicValueRW Specific Methodss

        #region ElectronicValueRW 1.15 Specific Methodss
        ...
        #endregion ElectronicValueRW 1.15 Specific Methodss
    }
}