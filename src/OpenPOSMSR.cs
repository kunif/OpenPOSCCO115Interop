...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.Msr, "OpenPOS 1.15 MSR", "OPOS MSR CCO Interop", 1, 15)]
    public class OpenPOSMSR : Msr, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSMSR _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSMSR();
        ...
        #endregion OPOSMSR  Specific Properties
        ...
        #endregion OPOSMSR  Specific Methodss
    }
}