...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.Cat, "OpenPOS 1.15 CAT", "OPOS CAT CCO Interop", 1, 15)]
    public class OpenPOSCAT : Cat, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSCAT _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSCAT();
        ...
        #endregion CAT Specific Properties
        ...
        #endregion CAT Specific Methodss
    }
}