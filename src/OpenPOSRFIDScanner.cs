...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.RFIDScanner, "OpenPOS 1.15 RFIDScanner", "OPOS RFIDScanner CCO Interop", 1, 15)]
    public class OpenPOSRFIDScanner : RFIDScanner, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSRFIDScanner _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSRFIDScanner();
        ...
        #endregion OPOSRFIDScanner  Specific Methodss
    }
}