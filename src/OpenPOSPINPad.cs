...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.PinPad, "OpenPOS 1.15 PINPad", "OPOS PINPad CCO Interop", 1, 15)]
    public class OpenPOSPINPad : PinPad, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSPINPad _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSPINPad();
        ...
        #endregion OPOSPINPad  Specific Properties
        ...
        #endregion OPOSPINPad  Specific Methodss
    }
}