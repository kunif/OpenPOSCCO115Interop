...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.CoinDispenser, "OpenPOS 1.15 CoinDispenser", "OPOS CoinDispenser CCO Interop", 1, 15)]
    public class OpenPOSCoinDispenser : CoinDispenser, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSCoinDispenser _cco = null;
        private const string _oposDeviceClass = "CoinDispenser";
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DirectIOEvent -= (_IOPOSCoinDispenserEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.StatusUpdateEvent -= (_IOPOSCoinDispenserEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSCoinDispenser();

                    // Register event handler
                    _cco.DirectIOEvent += new _IOPOSCoinDispenserEvents_DirectIOEventEventHandler(_cco_DirectIOEvent);
                    _cco.StatusUpdateEvent += new _IOPOSCoinDispenserEvents_StatusUpdateEventEventHandler(_cco_StatusUpdateEvent);
                }
                catch
                {
        ...
        #region OPOSCoinDispenser  Specific Properties
        ...
        public override CoinDispenserStatus DispenserStatus
        {
            get { return (CoinDispenserStatus)InteropEnum<CoinDispenserStatus>.ToEnumFromInteger(_cco.DispenserStatus); }
        }

        #endregion OPOSCoinDispenser  Specific Properties

        #region OPOSCoinDispenser  Specific Methodss
        ...
        #endregion OPOSCoinDispenser  Specific Methodss
    }
}