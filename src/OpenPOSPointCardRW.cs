...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.PointCardRW, "OpenPOS 1.15 PointCardRW", "OPOS PointCardRW CCO Interop", 1, 15)]
    public class OpenPOSPointCardRW : PointCardRW, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSPointCardRW _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSPointCardRW();
        ...
        #endregion OPOSPointCardRW  Specific Properties
        ...
        #endregion OPOSPointCardRW  Specific Methodss
    }
}