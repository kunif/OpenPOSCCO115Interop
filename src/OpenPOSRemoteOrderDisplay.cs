...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.RemoteOrderDisplay, "OpenPOS 1.15 RemoteOrderDisplay", "OPOS RemoteOrderDisplay CCO Interop", 1, 15)]
    public class OpenPOSRemoteOrderDisplay : RemoteOrderDisplay, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSRemoteOrderDisplay _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSRemoteOrderDisplay();
        ...
        #endregion OPOSRemoteOrderDisplay  Specific Methodss
    }
}