...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.LineDisplay, "OpenPOS 1.15 LineDisplay", "OPOS LineDisplay CCO Interop", 1, 15)]
    public class OpenPOSLineDisplay : LineDisplay, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSLineDisplay _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSLineDisplay();
        ...
        #endregion OPOSLineDisplay  Specific Properties
        ...
        #endregion OPOSLineDisplay  Specific Methodss
    }
}