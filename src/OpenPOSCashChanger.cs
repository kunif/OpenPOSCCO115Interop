...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.CashChanger, "OpenPOS 1.15 CashChanger", "OPOS CashChanger CCO Interop", 1, 15)]
    public class OpenPOSCashChanger : CashChanger, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSCashChanger _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSCashChanger();
        ...
        #endregion OPOSCashChanger  Specific Properties
        ...
        #endregion OPOSCashChanger  Specific Methodss
    }
}