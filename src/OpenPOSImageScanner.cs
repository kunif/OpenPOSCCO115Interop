...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.ImageScanner, "OpenPOS 1.15 ImageScanner", "OPOS ImageScanner CCO Interop", 1, 15)]
    public class OpenPOSImageScanner : ImageScanner, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSImageScanner _cco = null;
        private const string _oposDeviceClass = "ImageScanner";
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DataEvent -= (_IOPOSImageScannerEvents_DataEventEventHandler)_cco_DataEvent;
                    _cco.DirectIOEvent -= (_IOPOSImageScannerEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.ErrorEvent -= (_IOPOSImageScannerEvents_ErrorEventEventHandler)_cco_ErrorEvent;
                    _cco.StatusUpdateEvent -= (_IOPOSImageScannerEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSImageScanner();

                    // Register event handler
                    _cco.DataEvent += new _IOPOSImageScannerEvents_DataEventEventHandler(_cco_DataEvent);
                    _cco.DirectIOEvent += new _IOPOSImageScannerEvents_DirectIOEventEventHandler(_cco_DirectIOEvent);
                    _cco.ErrorEvent += new _IOPOSImageScannerEvents_ErrorEventEventHandler(_cco_ErrorEvent);
                    _cco.StatusUpdateEvent += new _IOPOSImageScannerEvents_StatusUpdateEventEventHandler(_cco_StatusUpdateEvent);
                }
                catch
                {
        ...
        #region OPOSImageScanner  Specific Properties

        public override bool CapAim
        {
            get { return _cco.CapAim; }
        }

        public override bool CapDecodeData
        {
            get { return _cco.CapDecodeData; }
        }

        public override bool CapHostTriggered
        {
            get { return _cco.CapHostTriggered; }
        }

        public override bool CapIlluminate
        {
            get { return _cco.CapIlluminate; }
        }

        public override bool CapImageData
        {
            get { return _cco.CapImageData; }
        }

        public override bool CapImageQuality
        {
            get { return _cco.CapImageQuality; }
        }

        public override bool CapVideoData
        {
            get { return _cco.CapVideoData; }
        }

        public override bool AimMode
        {
            get
            {
                return _cco.AimMode;
        ...
        // not defined on POS for.NET
        //public int BitsPerPixel
        //{
        //    get { return _cco.BitsPerPixel; }
        //}

        public override System.Collections.ObjectModel.ReadOnlyCollection<System.Drawing.Bitmap> FrameData
        {
            get
            {
                string FrameDataString = _cco.FrameData;

                if (!string.IsNullOrEmpty(FrameDataString))
                {
                    List<System.Drawing.Bitmap> listBtmap = new List<System.Drawing.Bitmap>();

                    try
                    {
                        System.Drawing.Image image = System.Drawing.Image.FromStream(new MemoryStream(InteropCommon.ToByteArrayFromString(FrameDataString, _binaryConversion)), true);
                        ...
                        for (int i = 0; i < frameCount; i++)
                        {
                            ...
                            listBtmap.Add(new System.Drawing.Bitmap(image));
                        }
                    }
                    catch
                    {
                    ...
                    return new System.Collections.ObjectModel.ReadOnlyCollection<System.Drawing.Bitmap>(listBtmap);
                }
                else
                {
                    return null;
        ...
        {
            get { return (FrameType)InteropEnum<FrameType>.ToEnumFromInteger(_cco.FrameType); }
        }

        public override bool IlluminateMode
        {
            get
            {
                return _cco.IlluminateMode;
            }
            set
            {
                _cco.IlluminateMode = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        //{
        //    get { return _cco.ImageHeight; }
        //}

        // not defined on POS for.NET
        //public int ImageLength
        //{
        //    get { return _cco.ImageLength; }
        //}
        ...
        public override ImageMode ImageMode
        {
            get
            {
                return (ImageMode)InteropEnum<ImageMode>.ToEnumFromInteger(_cco.ImageMode);
            }
            set
            {
                _cco.ImageMode = (int)value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override ImageQuality ImageQuality
        {
            get
            {
                return (ImageQuality)InteropEnum<ImageQuality>.ToEnumFromInteger(_cco.ImageQuality);
            }
            set
            {
                _cco.ImageQuality = (int)value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int VideoCount
        {
            get
            {
                return _cco.VideoCount;
            }
            set
            {
                _cco.VideoCount = value;
                VerifyResult(_cco.ResultCode);
            }
        }

        public override int VideoRate
        {
            get
            {
                return _cco.VideoRate;
            }
            set
            {
                _cco.VideoRate = value;
                VerifyResult(_cco.ResultCode);
            }
        }

        #endregion OPOSImageScanner  Specific Properties

        #region OPOSImageScanner  Specific Methodss

        public override void StartSession()
        {
            VerifyResult(_cco.StartSession());
        }

        public override void StopSession()
        {
            VerifyResult(_cco.StopSession());
        }

        #endregion OPOSImageScanner  Specific Methodss
    }
}