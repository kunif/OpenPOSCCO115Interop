...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.ToneIndicator, "OpenPOS 1.15 ToneIndicator", "OPOS ToneIndicator CCO Interop", 1, 15)]
    public class OpenPOSToneIndicator : ToneIndicator, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSToneIndicator _cco = null;
        private const string _oposDeviceClass = "ToneIndicator";
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DirectIOEvent -= (_IOPOSToneIndicatorEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.ErrorEvent -= (_IOPOSToneIndicatorEvents_ErrorEventEventHandler)_cco_ErrorEvent;
                    _cco.OutputCompleteEvent -= (_IOPOSToneIndicatorEvents_OutputCompleteEventEventHandler)_cco_OutputCompleteEvent;
                    _cco.StatusUpdateEvent -= (_IOPOSToneIndicatorEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSToneIndicator();

                    // Register event handler
                    _cco.DirectIOEvent += new _IOPOSToneIndicatorEvents_DirectIOEventEventHandler(_cco_DirectIOEvent);
                    _cco.ErrorEvent += new _IOPOSToneIndicatorEvents_ErrorEventEventHandler(_cco_ErrorEvent);
                    _cco.OutputCompleteEvent += new _IOPOSToneIndicatorEvents_OutputCompleteEventEventHandler(_cco_OutputCompleteEvent);
                    _cco.StatusUpdateEvent += new _IOPOSToneIndicatorEvents_StatusUpdateEventEventHandler(_cco_StatusUpdateEvent);
                }
                catch
                {
        ...
        {
            get { return _cco.CapMelody; }
        }

        public override bool CapPitch
        {
            get { return _cco.CapPitch; }
        }
        ...
        public override int InterToneWait
        {
            get
            {
                return _cco.InterToneWait;
            }
            set
            {
                _cco.InterToneWait = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override MelodyType MelodyType
        {
            get
            {
                return (MelodyType)InteropEnum<MelodyType>.ToEnumFromInteger(_cco.MelodyType);
            }
            set
            {
                _cco.MelodyType = (int)value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int MelodyVolume
        {
            get
            {
                return _cco.MelodyVolume;
            }
            set
            {
                _cco.MelodyVolume = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone1Duration
        {
            get
            {
                return _cco.Tone1Duration;
            }
            set
            {
                _cco.Tone1Duration = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone1Pitch
        {
            get
            {
                return _cco.Tone1Pitch;
            }
            set
            {
                _cco.Tone1Pitch = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone1Volume
        {
            get
            {
                return _cco.Tone1Volume;
            }
            set
            {
                _cco.Tone1Volume = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone2Duration
        {
            get
            {
                return _cco.Tone2Duration;
            }
            set
            {
                _cco.Tone2Duration = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone2Pitch
        {
            get
            {
                return _cco.Tone2Pitch;
            }
            set
            {
                _cco.Tone2Pitch = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public override int Tone2Volume
        {
            get
            {
                return _cco.Tone2Volume;
            }
            set
            {
                _cco.Tone2Volume = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        #region ToneIndicator Specific Methodss
        ...
        {
            VerifyResult(_cco.SoundImmediate());
        }

        #endregion ToneIndicator Specific Methodss
    }
}