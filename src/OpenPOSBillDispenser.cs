...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.BillDispenser, "OpenPOS 1.15 BillDispenser", "OPOS BillDispenser CCO Interop", 1, 15)]
    public class OpenPOSBillDispenser : BillDispenser, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSBillDispenser _cco = null;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DirectIOEvent -= (OpenPOS.Devices._IOPOSBillDispenserEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.StatusUpdateEvent -= (OpenPOS.Devices._IOPOSBillDispenserEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSBillDispenser();
        ...
        #endregion OPOSBillDispenser  Specific Properties
        ...
        #endregion OPOSBillDispenser  Specific Methodss
    }
}