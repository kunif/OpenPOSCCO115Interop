...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.FiscalPrinter, "OpenPOS 1.15 FiscalPrinter", "OPOS FiscalPrinter CCO Interop", 1, 15)]
    public class OpenPOSFiscalPrinter : FiscalPrinter, IFiscalPrinter115, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSFiscalPrinter _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSFiscalPrinter();
        ...
        #endregion FiscalPrinter Specific Properties

        #region FiscalPrinter 1.15 Specific Properties

        public FiscalCountryCodes115 CountryCode115
        {
            get { return (FiscalCountryCodes115)InteropEnum<FiscalCountryCodes115>.ToEnumFromInteger(_cco.CountryCode); }
        }

        public FiscalDateType115 DateType115
        {
            get
            {
                return (FiscalDateType115)InteropEnum<FiscalDateType115>.ToEnumFromInteger(_cco.DateType);
            }
            set
            {
                _cco.DateType = (int)value;
        ...
        #endregion FiscalPrinter 1.15 Specific Properties
        ...
        #endregion FiscalPrinter Specific Methodss
    }
}