...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.Micr, "OpenPOS 1.15 MICR", "OPOS MICR CCO Interop", 1, 15)]
    public class OpenPOSMICR : Micr, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSMICR _cco = null;
        ...
        #endregion OPOSMICR  Specific Properties
        ...
        #endregion OPOSMICR  Specific Methodss
    }
}