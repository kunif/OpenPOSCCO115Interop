...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.HardTotals, "OpenPOS 1.15 HardTotals", "OPOS HardTotals CCO Interop", 1, 15)]
    public class OpenPOSHardTotals : HardTotals, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSTotals _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSTotals();
        ...
        #endregion OPOSHardTotals  Specific Properties
        ...
        #endregion OPOSHardTotals  Specific Methodss
    }
}