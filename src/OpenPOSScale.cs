...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.Scale, "OpenPOS 1.15 Scale", "OPOS Scale CCO Interop", 1, 15)]
    public class OpenPOSScale : Scale, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSScale _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSScale();
        ...
        #endregion OPOSScale  Specific Properties
        ...
        #endregion OPOSScale  Specific Methodss
    }
}