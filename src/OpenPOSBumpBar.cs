...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.BumpBar, "OpenPOS 1.15 BumpBar", "OPOS BumpBar CCO Interop", 1, 15)]
    public class OpenPOSBumpBar : BumpBar, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSBumpBar _cco = null;
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSBumpBar();
        ...
        #endregion OPOSBumpBar  Specific Properties
        ...
        #endregion OPOSBumpBar  Specific Methodss
    }
}