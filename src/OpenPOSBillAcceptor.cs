...
namespace OpenPOS.CCO115Interop
{
    ...
    [ServiceObject(DeviceType.BillAcceptor, "OpenPOS 1.15 BillAcceptor", "OPOS BillAcceptor CCO Interop", 1, 15)]
    public class OpenPOSBillAcceptor : BillAcceptor, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSBillAcceptor _cco = null;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DataEvent -= (OpenPOS.Devices._IOPOSBillAcceptorEvents_DataEventEventHandler)_cco_DataEvent;
                    _cco.DirectIOEvent -= (OpenPOS.Devices._IOPOSBillAcceptorEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.StatusUpdateEvent -= (OpenPOS.Devices._IOPOSBillAcceptorEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSBillAcceptor();
        ...
        #endregion OPOSBillAcceptor  Specific Properties
        ...
        #endregion OPOSBillAcceptor  Specific Methodss
    }
}